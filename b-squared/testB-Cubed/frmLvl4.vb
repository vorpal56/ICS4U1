Public Class frmLvl4
    ...
    Public platform(23) As Object
    Public Done(23) As Boolean
    ...
    Private Sub frmLvl4_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        If picChar.Bounds.IntersectsWith(picBoxEnd.Bounds) Then
            ...
            picBox13.Size = New Size(0, 0) And picBox14.Size = New Size(0, 0) And _
            ...
            picBox22.Size = New Size(0, 0) Then
                keyspressed = False
                tmrTime.Stop()
                tmrFlash.Start()
            ...
            Else
                ...
                Delay(0.3)
                keyspressed = True
                picChar.Location = New Point(77, 250)
            End If
        End If
    ...
    Private Sub tmrCheck_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrCheck.Tick
        ...
        For x As Integer = 0 To 23 'array of boxes
            If picChar.Bounds.IntersectsWith(platform(x).bounds) Then
                Exit For
            ElseIf x = 23 Then 'if char is not in any boxes reset location (214,148)
                System.Threading.Thread.Sleep(80)
                picChar.Location = New Point(77, 250)
                For i As Integer = 0 To 23 'Reseting Portion
                    picChar.Location = New Point(77, 250)
        ...
        For x As Integer = 0 To 23 'finds the block you just left and puts it into asd
            If picChar.Bounds.IntersectsWith(platform(x).bounds) Then
