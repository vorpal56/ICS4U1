Public Class frmLvl3
    ...
    Public platform(20) As Object
    Public Done(20) As Boolean
    Public keyspressed As Boolean = True
    Public msgflash As Integer

    Private Sub frmLvl3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        platform(20) = picBoxEnd

    End Sub

    Private Sub frmLvl3_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        If picChar.Bounds.IntersectsWith(picBoxEnd.Bounds) Then
            ...
            picBox19.Size = New Size(0, 0) Then
                keyspressed = False
                tmrTime.Stop()
                tmrFlash.Start()
            ...
            Else
                ...
                Delay(0.3)
                keyspressed = True
                picChar.Location = New Point(211, 56)
            End If
        End If

    End Sub

    Private Sub frmLvl3_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub tmrCheck_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrCheck.Tick
        ...
        For x As Integer = 0 To 20 'array of boxes
            If picChar.Bounds.IntersectsWith(platform(x).bounds) Then
                Exit For
            ElseIf x = 20 Then 'if char is not in any boxes reset location (214,148)
                System.Threading.Thread.Sleep(80)
                picChar.Location = New Point(211, 56)
                For i As Integer = 0 To 20 'Reseting Portion
                    picChar.Location = New Point(211, 56)
        ...
        For x As Integer = 0 To 20 'finds the block you just left and puts it into asd
            If picChar.Bounds.IntersectsWith(platform(x).bounds) Then
